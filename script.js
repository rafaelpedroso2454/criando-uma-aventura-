"
        <div chref="https://fonts.gstatic.com" crossorigin>
    <link href="https://fo<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta c harset="UTF-8">
    ...
    <link rel="preconnectnts.googleapis.com/css2?family=Bai+Jamjuree:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;1,200;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
    <title>Em busca da cidade perdida</title>
</head>
<body>
    <main>lass="passo ativo" id="passo-0">
